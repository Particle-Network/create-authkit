      ...
      <div className="filter-box card" style={{ flex: 1 }}>
          ...
          <Select
            ...
            onChange={(value) => {
              setPromptSettingConfig({
                ...
                promptPaymentPasswordSettingWhenSign: promptSettingConfig?.promptPaymentPasswordSettingWhenSign,
              });
            }}
            style={{ width: 100 }}
        ...
        <div className="filter-item">
          ...
          <Select
            ...
            onChange={(value) => {
              setPromptSettingConfig({
                promptMasterPasswordSettingWhenLogin: promptSettingConfig?.promptMasterPasswordSettingWhenLogin,
